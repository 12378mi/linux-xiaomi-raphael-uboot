...
# 克隆指定版本的内核源码
git clone https://github.com/12378mi/linux.git --branch raphael-$1 --depth 1 linux
cd linux

# 下载内核配置文件
wget -P arch/arm64/configs https://github.com/12378mi/kernel-deb/blob/main/raphael.config
